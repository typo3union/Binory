<?php
namespace Project\Project\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
 *  (c) 2015 
...
/**
 * Test case for class Project\Project\Controller\ProjectController.
 *
 */
class ProjectControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {

	/**
	 * @var \Project\Project\Controller\ProjectController
	 */
	protected $subject = NULL;

	public function setUp() {
		$this->subject = $this->getMock('Project\\Project\\Controller\\ProjectController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllProjectsFromRepositoryAndAssignsThemToView() {
		...
		$projectRepository = $this->getMock('Project\\Project\\Domain\\Repository\\ProjectRepository', array('findAll'), array(), '', FALSE);
	...
	public function showActionAssignsTheGivenProjectToView() {
		$project = new \Project\Project\Domain\Model\Project();
