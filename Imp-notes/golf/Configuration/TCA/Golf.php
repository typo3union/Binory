...
$GLOBALS['TCA']['tx_golf_domain_model_golf'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, putting_holes, name, title, video_image, video, hole_image, par, hcp, red, green,m_green, pinposition_image, slider_images, description_title,content, tx_golf_table',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, putting_holes, name, title, video_image, video, hole_image, par, hcp, red, green, m_green,pinposition_image, slider_images,description_title, content;;;richtext:rte_transform[mode=ts_links], tx_golf_table;;;richtext:rte_transform[mode=ts_links], --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
